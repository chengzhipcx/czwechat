...
public class Constant {
    ...
    //·þÎñÆ÷¶Ë
    public static final String URL_Register = "http://192.168.1.9:8099/user/register";
    public static final String URL_Register_Tel = "http://120.24.211.126/fanxin/register_tel.php";
    public static final String URL_Login = "http://192.168.1.9:8099/user/login";
    public static final String URL_Friends = "http://192.168.1.9:8099/user/getFriends";
    public static final String URL_addFriends = "http://192.168.1.9:8099/user/addFriends";
    public static final String URL_MyFriends = "http://192.168.1.9:8099/user/getMyFriends";
