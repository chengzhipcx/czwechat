...
import cn.buaa.myweixin.ui.MainActivity;
...
public class MainWeixin extends Activity {
	...
	private RelativeLayout add_friendq_rl;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// add_friend_rl = (TextView) findViewById(R.id.add_friend_rl);
		// add_friend_rl.setOnClickListener(new OnClickListener() {
		...
		// this.findViewById(R.id.listView_myfriends);
		//
		// 获取到集合数据
		// List<HashMap<String, Object>> data =NetUtils.getOurFriendData();
		//
	...
	public class MyOnPageChangeListener implements OnPageChangeListener {
		...
		public void onPageSelected(int arg0) {
			...
			case 0:
				...
				break;
			case 1:
				ListView listView = (ListView) MainWeixin.this
						.findViewById(R.id.listView_myfriends);
				// 获取到集合数据
				List<HashMap<String, Object>> data = NetUtils
						.getOurFriendData(userId);
				// //创建SimpleAdapter适配器将数据绑定到item显示控件上
				SimpleAdapter adapter = new SimpleAdapter(MainWeixin.this,
						data, R.layout.item_myf, new String[] { "name", "phone",
	...
	public void startchat(View v) { // 平常心 对话界面
	...
	public void btn_addFriend(View v) { // 添加好友
		add_friend_rl = (RelativeLayout) findViewById(R.id.add_friend_rtl);
		add_friend_rl.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(MainWeixin.this, AddFriend.class);
				startActivity(intent);
			}
		});
	}

	public void btn_addFriendq(View v) { // 添加好友
	// add_friendq_rl = (RelativeLayout) findViewById(R.id.friendq_rtl);
	// add_friendq_rl.setOnClickListener(new OnClickListener() {
	// public void onClick(View v) {
		System.out.println("---------------------");
	...
	private final class ItemClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			System.out.println("11111111111111" + personid);
			// 添加好友
			String state = NetUtils.addfriend(11, Integer.parseInt(personid));
